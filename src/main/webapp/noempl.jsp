...
<%//to display when no employee or job has been posted
String t=(String)session.getAttribute("error"); %>
    <div class="mainbox">

    <div style="font-size: 30px" class="msg"><%=t%>.<p>Go to <a href="addjob.html">home</a> or <a href="index.html">logout </a></p></div>
      </div>
